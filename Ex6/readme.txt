...
Functions description : 
    1. calc_target_length
        ...
        It makes sense because in the Uniform Laplacian curvature, the higher the curvature in the mesh, the bigger its associated value.
		And in our case, we would like to split more the high curvatures than the low ones, so we want the target length of a vertex to be proportional to its curvature value.
