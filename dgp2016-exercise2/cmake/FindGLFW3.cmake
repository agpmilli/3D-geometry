...
IF (WIN32)
    IF( CMAKE_SIZEOF_VOID_P EQUAL 8 )
        SET( BITS "64")
                SET(LIBPATH ${CMAKE_SOURCE_DIR}/externals/glfw3/x64/lib-vc2015/)
                SET(INCLPATH ${CMAKE_SOURCE_DIR}/externals/glfw3/x64/include)
    ELSE()
                SET(LIBPATH ${CMAKE_SOURCE_DIR}/externals/glfw3/x32/lib-vc2015/)
                SET(INCLPATH ${CMAKE_SOURCE_DIR}/externals/glfw3/x32/include)
    ENDIF()
ENDIF()
